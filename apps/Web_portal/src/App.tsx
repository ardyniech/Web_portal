  ...
  const loadAdminData = async () => {
    ...
    try {
      ...
      if (e.message === 'Unauthorized') {
        ...
        console.error('Error loading admin configs:', e);
        // Do not logout on transient network errors, just notify
        // triggerNotification('error', 'Error loading admin data. Please check connection.');
      }
    }
  };
