...
const DEFAULT_STATE: DatabaseState = {
  ...
  nginxConfigs: [
    ...
    },
    {
      ...
      sslType: 'Cloudflare',
      isLoadBalanced: true,
      upstreams: ['http://127.0.0.1:8001 weight=3', 'http://127.0.0.1:54322 weight=2'],
      isActive: true,
      lastGeneratedContent: '',
      createdAt: new Date().toISOString()
    }
  ...
  portForwards: [
    {
      ...
      localPort: 56235,
      webhookEnabled: true,
      webhookUrl: 'http://localhost:56235/api/webhooks/github',
      status: 'Active'
    },
    {
      id: 'pf_2',
...
export class DbStore {
  ...
  public authenticate(username: string, passwordPlain: string): string | null {
    ...
    console.log(`[AUTH DEBUG] User: ${normUser}, StoredHash: ${storedHash}, InputHash: ${inputHash}`);
