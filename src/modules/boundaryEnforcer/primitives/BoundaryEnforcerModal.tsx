...
import { ShieldCheck, X, RefreshCw, AlertTriangle, CheckCircle, FileCode } from 'lucide-react';
...
export function BoundaryEnforcerModal({ onClose }: BoundaryEnforcerModalProps) {
  const { report, loading, refresh } = useBoundaryEnforcer();
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-zinc-500 font-medium mt-0.5">
                Pengawasan isolasi modul, pencegahan import privat cross-module, dan penegakan limit &lt;125 baris
              </p>
            </div>
          </div>
